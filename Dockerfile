...
ARG PLUGINS="elementor wpforms-lite wp-stateless-elementor wp-stateless-wpforms header-footer-elementor wp-stateless custom-fonts wordpress-importer forminator"
ENV PLUGINS=$PLUGINS
